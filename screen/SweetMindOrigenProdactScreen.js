...
const SweetMindOrigenProdactScreen = ({navigation, route}) => {
  ...
  const setData = async () => {
    try {
      ...
      await AsyncStorage.setItem('SweetMindOrigenProdactScreen', jsonData);
    ...
    return (
      <View
        style={{
          ...
          alignItems: 'center',
          backgroundColor: '#fe80dd', // затемнення
        }}>
...
export default SweetMindOrigenProdactScreen;
