...
//////
import SweetMindOrigenProdactScreen from './screen/SweetMindOrigenProdactScreen';
//////
...
function App() {
  ...
  const INITIAL_URL = `https://space-play-place.com/`;
  const URL_IDENTIFAIRE = `tf99R4gx`;
  ...
  OneSignal.initialize('a9b5baa5-fcb2-4b0f-9b94-db98bf27f984');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="SweetMindOrigenProdactScreen"
            component={SweetMindOrigenProdactScreen}
      ...
      <NavigationContainer>
        {!louderIsEnded ? (
          <View
            ...
            <Animated.Image
              source={require('./assets/image/bg/loader1.jpg')}
              style={{
                //...props.style,
            ...
            />
            <Animated.Image
              source={require('./assets/image/bg/loader2.jpg')}
              style={{
                //...props.style,
